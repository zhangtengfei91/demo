...
//@JsonIdentityInfo(generator=ObjectIdGe    nerators.PropertyGenerator.class, property="id")
public class User extends BaseEntity implements UserDetails   {
    ...
    public long jobPosition;//职务
    public String Post;    //岗位
    public String delayWarm;//管理员
    public String lab;  //实验室
    public String surveillancePro;//检测项目
    public String labMan;
    ...
    public String getLabMan() {
        return labMan;
    }

    public void setLabMan(String labMan) {
        this.labMan = labMan;
    }
}
