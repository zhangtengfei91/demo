    ...
    public UserFrom userToUserForm(User user){
        ...
        if(user.getGroup()!=null){//user.group
            ...
            if(user.getGroup().getCreatedDate()!=null){
                try{
                    groupFrom.createdDate=dateFormat.format(user.getGroup().getCreatedDate());
                }
                catch (Exception e){}
            ...
            if(user.getGroup().getLastModifiedDate()!=null){
                try{
                    groupFrom.lastModifiedDate=dateFormat.format(user.getGroup().getLastModifiedDate());
                }
                catch (Exception e){}
            }
    ...
    public MissiveReceiveRender MissiveReceive2MissiveReceiveRender(MissiveRecSeeCard mrsc,String taskName){
        ...
        if(mrsc!=null){
           ...
           if(mrsc.getCode()!=null){
            ...
            else if(mrsc.getToDoDateMonth()==null&&taskName.equals("办公室拟办")){
            ...
            else if(mrsc.getToDoDateDay()==null&&taskName.equals("办公室拟办")){
            ...
            else if(mrsc.getInstructDateDay()==null&&taskName.equals("领导批示")){
