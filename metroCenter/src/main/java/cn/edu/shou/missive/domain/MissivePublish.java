...
public class MissivePublish extends BaseEntity{
    ...
    //郑小罗 2014/12/26 添加公文签名关联
    @Getter @Setter
    @ManyToOne(cascade = CascadeType.ALL)
    @JoinColumn(name = "missiveSignImg")
    private MissiveVersion.MissiveSignImg missiveSignImg;
...
//    @JoinColumn(name="backgroudImage")
    ...
    public MissiveVersion.MissiveSignImg getMissiveSignImg() {
        return missiveSignImg;
    }

    public void setMissiveSignImg(MissiveVersion.MissiveSignImg missiveSignImg) {
        this.missiveSignImg = missiveSignImg;
    }
}